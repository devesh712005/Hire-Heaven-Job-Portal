...
import { ArrowRight, Briefcase, Divide, Lock, Mail } from "lucide-react";
          ...
          <form onSubmit={submitHandler} className="space-y-5">
            <div className="space-y-2 ">
              ...
              <div className="relative">
                <Briefcase className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 opacity-50 pointer-events-none" />
                <select
                  id="role"
                  value={role}
            ...
            {role && (
              <div className="space-y-5 animate-in fade-in duration-300">
                <div className="space-y-2 ">
                  ...
                  <div className="relative">
                    <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 opacity-50 pointer-events-none" />
                    <Input
                      type="name"
                      id="name"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative ">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 opacity-50 pointer-events-none" />
                    <Input
                      type="password"
                      id="password"
                      placeholder="********"
