...
import { Application, Job } from "@/components/type";
                  ...
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        <span
                          className={`px-3 py-1.5 rounded-full text-sm font-medium ${job.is_active ? "bg-green-100 dark:bg-green-900/30 text-green-600" : "bg-red-100 dark:bg-red-900/30 text-red-600"} `}
                        >
      ...
      {user && job && user.user_id == job.posted_by_recruiter_id && (
        <div className="w-[90%] md:w-2/3 container mx-auto mt-8 mb-8">
          ...
          {jobApplications && jobApplications?.length > 0 ? (
            ...
            <>
              <p className="text-center py-8 opacity-70 ">
                No application yet {filterStatus}
              </p>
            </>
          )}
        </div>
